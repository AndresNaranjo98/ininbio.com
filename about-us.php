                ...
                <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                  ...
                  <ul class="rd-navbar-nav">
                   <li class="rd-nav-item "><a class="rd-nav-link" href="index.php">Inicio</a>
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="about-us.php">Acerca de Nosotros</a>
                    </li>
...
<br>
      ...
      <section class="section novi-background section-md text-center bg-gray-100">
        <div class="container">
          <h3 class="text-uppercase wow-outer"><span class="wow slideInUp">Por qué la gente nos elige</span></h3>
