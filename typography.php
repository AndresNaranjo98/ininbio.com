...
<body>
  ...
  <div class="page">
                ...
                <ul class="rd-navbar-nav menu-horizontal">
                  ...
                  <li class="rd-nav-item">
                    ...
                    <ul class="menu-vertical" id="menu-vertical" style="text-align: center;">
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="typography.php" style="text-align: center;">Productos</a></li>
                      <li class="rd-nav-item" style="margin-left: 0px; text-align: center;">
    ...
    $consultaLogin = "SELECT * FROM productos";
          ...
          ?>
            <div class="pr">
              ...
              <div class="media-icons">
                <a href="#" data-toggle="modal" aria-label="infoProducto" data-target="#modalProducto<?php echo $idPro ?>"><i class="fa-solid fa-info" style=" padding-top: 25%;"></i></a>
              </div>
            </div>
