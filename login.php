              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="register.php"><span class="icon novi-icon icon-md mdi mdi-account"></span></a>
                    </li>
            ...
            <div class="col-md-6" 
                ...
                <br>
                    <div style="margin: 0 auto; display: inline-block; margin-top: 2%;">
                        <button type="submit" class="button button-primary button-winona button-md wow slideInRight">Iniciar Sesión</button>
                    </div>
            </div>
<br>
<br>
            <p>¿No tienes cuenta? <a class="rd-nav-link rd-nav-item" href="register.php" style="color: #2d9082;"> Crear Cuenta</a></p>
