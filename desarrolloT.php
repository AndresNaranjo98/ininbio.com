...
<head>
  <title>Ininbio/Desarrollo Tecnologico</title>
                ...
                <ul class="rd-navbar-nav menu-horizontal">
                  ...
                  <li class="rd-nav-item">
                    ...
                    <ul class="menu-vertical" id="menu-vertical" style="text-align: center;">
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="desarrolloT.php" style="text-align: center;">Desarrollo Tecnologico</a></li>
                    </ul>
                  </li>
    ...
    <section class="section novi-background section-xl">
      ...
      <div style="margin-top: 30px;">
        <div class="imagenPrueba">
          <img src="./images/monitoreoFermentacion.webp" alt="monitoreoFermentación">
