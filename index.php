            ...
            <div class="container">
              <div class="jumbotron-classic-content">
                ...
                <!-- <p class="text-white wow-outer"> -->
                  ...
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-target"></span><div style="margin-left: 5px;">Ajustables a su proceso de fermentación</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-target"></span><div style="margin-left: 5px;">Poseen actividad enzimática </div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-target"></span><div style="margin-left: 5px;">Productos con grado alimenticio</div></li>
            ...
            <div class="container">
              <div class="jumbotron-classic-content">
                ...
                <!-- <h1 class="text-uppercase text-white font-weight-bold wow-outer"><span class="wow slideInDown" data-wow-delay=".2s">Rent & Sale</span></h1> -->
                  <ul class="text-white font-weight-bold wow-outer wow slideInDown">
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-trophy-award" style="color: gold;"></span><div style="margin-left: 5px;">Medalla de oro a la Calidad y Servicio</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-trophy-award" style="color: gold;"></span><div style="margin-left: 5px;">Productos con certificado KOSHER</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-trophy-award" style="color: gold;"></span><div style="margin-left: 5px;">Planta de producción con certificado FDA</div></li>
                  <!-- <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-target"></span><div style="margin-left: 5px;">100% Mexicano</div></li> -->
                  </ul>
                <div class="wow-outer button-outer"><a class="button button-md button-primary button-winona wow slideInDown" href="certificaciones.php" data-wow-delay=".4s">Conoce más</a></div>
              </div>
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="images/estudios-gratuitos.jpg">
            <div class="container">
              <div class="jumbotron-classic-content">
                ...
                <ul class="text-white font-weight-bold wow-outer wow slideInDown">
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-eyedropper" style="color: #71c500;"></span><div style="margin-left: 5px;">Análisis In Situ</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-eyedropper" style="color: #71c500;"></span><div style="margin-left: 5px;">Aislamiento de selección de cepas</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-eyedropper" style="color: #71c500"></span><div style="margin-left: 5px;">Trabajos de propagación de cepas</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-eyedropper" style="color: #71c500;"></span><div style="margin-left: 5px;">Desarrollo de nutrientes específicos</div></li>
                  <li style="display: flex;"><span class="icon novi-icon icon-sm mdi mdi-eyedropper" style="color: #71c500;"></span><div style="margin-left: 5px;">Estudios de caracterización genética</div></li>
                <div class="wow-outer button-outer"><a class="button button-md button-primary button-winona wow slideInDown" href="typography.php" data-wow-delay=".4s">Conoce más</a></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row row-lg-50 row-35 offset-top-2">
            <div class="col-md-6 wow-outer">
              ...
              ">
                  ...
                  <div class="content">
                    ...
                    <br>
                    <br>
                    <a class="fa-sharp fa-solid fa-cart-plus fa-2x iconoProducto" style=" color: #71c500;"></a>
                    <a class="fa-solid fa-circle-info fa-2x iconoProducto" href="producto2.html" style="color: #2c9182;"></a>
                  </div>
                </div>
                <h4 class="post-modern-title"><a class="post-modern-title" >5619 Walnut Hill Ln, Dallas, TX 75229</a></h4>
                <ul class="post-modern-meta">
                  <li><a class="button-winona">$1500/mon</a></li>
                  <li>30 Sq. Ft.</li>
                  <li>3 Bedrooms</li>
                </ul>
            ...
            <div class="col-md-6 wow-outer">
              <!-- Post Modern-->
              <article class="post-modern wow slideInLeft">
                <!-- <img src="images/nutri-fast.png" alt="" width="570" height="352" class="card" style=""/></a> -->
                <div class="card" style="--i:url(../images/nutri-fast.png)">
                  <div class="content">
                    <br>
                    <br>
                    <br>
                    ...
                    <br>
                    <a class="fa-sharp fa-solid fa-cart-plus fa-2x iconoProducto" style="color: #71c500;"></a>
                    <a class="fa-solid fa-circle-info fa-2x iconoProducto" href="producto1.html" style="color: #2c9182;"></a>
                  </div>
              </div>
                <h4 class="post-modern-title"><a class="post-modern-title">1808 Bolingbroke Pl, Fort Worth, TX 76140</a></h4>
                <ul class="post-modern-meta">
                  <li><a class="button-winona" >$1300/mon</a></li>
                  <li>40 Sq. Ft.</li>
                  <li>2 Bedrooms</li>
                </ul>
            ...
            <div class="col-md-6 wow-outer">
              <!-- Post Modern-->
              <article class="post-modern wow slideInLeft">
                <div class="card" style="--i:url(../images/nutri-ferm.png)">
                  <div class="content">
                    <br>
                    <br>
                    <br>
                    ...
                    <br>
                    <a class="fa-sharp fa-solid fa-cart-plus fa-2x iconoProducto" style="color: #71c500;"></a>
                    <a class="fa-solid fa-circle-info fa-2x iconoProducto" href="producto3.html" style="color: #2c9182;"></a>
                  </div>
              </div>
                <h4 class="post-modern-title"><a class="post-modern-title">924 Bel Air Rd, Los Angeles, CA 90077</a></h4>
                <ul class="post-modern-meta">
                  <li><a class="button-winona">$1800/mon</a></li>
                  <li>50 Sq. Ft.</li>
                  <li>4 Bedrooms</li>
                </ul>
            ...
            <div class="col-md-6 wow-outer">
              <!-- Post Modern-->
              <article class="post-modern wow slideInLeft">
                <div class="card" style="--i:url(../images/vinimax.png)">
                  <div class="content">
                    <br>
                    <br>
                    <br>
                    ...
                    <br>
                  <a class="fa-sharp fa-solid fa-cart-plus fa-2x iconoProducto" style="color: #71c500;"></a>
                  <a class="fa-solid fa-circle-info fa-2x iconoProducto" href="producto4.html" style="color: #2c9182;"></a>
                  </div>
                </div>
                <h4 class="post-modern-title"><a class="post-modern-title">13510 W Cheery Lynn Rd, Avondale, AZ 85392</a></h4>
                <ul class="post-modern-meta">
                  <li><a class="button-winona">$2700/mon</a></li>
                  <li>90 Sq. Ft.</li>
                  <li>2 Bedrooms</li>
                </ul>
            ...
            <div class="col-md-12 wow-outer"><a class="button button-primary button-winona button-md" href="typography.php">Ver más productos</a></div>
          </div>
        </div>
      </section>
            ...
            <div class="footer-advanced-layout">
              <div>
                <ul class="list-nav"> 
                  ...
                  <li><a href="typography.php">Productos</a></li>
