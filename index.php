                  ...
                  <li class="rd-nav-item">
                    ...
                    <ul class="menu-vertical" id="menu-vertical" style="text-align: center;">
                      ...
                      <li class="rd-nav-item" style="text-align: center;">
                        ...
                        <a class="rd-nav-link" id="levadurasMovil" href="#" onclick="levaduras()" style="cursor: pointer;">Levaduras</a>
        ...
        <div class="row row-30">
          <div class="col-sm-6 col-lg-6 wow-outer">
            ...
            <article class="box-minimal">
              <div class="box-chloe__icon novi-icon fa-solid fa-flask-vial wow fadeIn iconosResponsive" data-wow-delay=".1s"></div>
          ...
          <div class="col-sm-6 col-lg-6 wow-outer">
            <!-- Box Minimal-->
            <article class="box-minimal">
              <div class="box-chloe__icon novi-icon fa-solid fa-virus wow fadeIn iconosResponsive" data-wow-delay=".1s"></div>
              <div class="box-minimal-main wow-outer">
          ...
          <div class="col-sm-6 col-lg-6 wow-outer">
            <!-- Box Minimal-->
            <article class="box-minimal">
              <div class="box-chloe__icon novi-icon fa-solid fa-microscope wow fadeIn iconosResponsive"></div>
              <div class="box-minimal-main wow-outer">
          ...
          <div class="col-sm-6 col-lg-6 wow-outer">
            <!-- Box Minimal -->
            <article class="box-minimal">
              <div class="box-chloe__icon novi-icon fa-solid fa-hand-holding-heart wow fadeIn iconosResponsive" data-wow-delay=".2s"></div>
              <div class="box-minimal-main wow-outer">
    ...
    <section class="section novi-background section-lg text-center">
      <div class="fondoSistemaFMT">
        ...
        <div class="wow-outer button-outer" style="margin-top: 0%;">
          <a class="button button-md button-primary wow slideInDown" href="desarrolloT.php" data-wow-delay=".4s" style="font-size: 20px; font-weight: normal;">Conoce más</a>
        </div>
      </div>
    </section>
