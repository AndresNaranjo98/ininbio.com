...
<body>
  ...
  <div class="page">
                ...
                <ul class="rd-navbar-nav menu-horizontal">
                  ...
                  <li class="rd-nav-item">
                    ...
                    <ul class="menu-vertical" id="menu-vertical" style="text-align: center;">
                      ...
                      <li class="rd-nav-item active" style="text-align: center;">
    ...
    <section class="section novi-background section-xl">
      ...
      <hr class="my-4" />
      <h3 style="text-align: center;" id="textoLevadura"></h3>
      <hr class="my-4" />
      <?php
      ...
      switch (isset($_POST)) {
        case isset($_POST['tequila']):
          ...
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%levadura%' && categoria like '%$botonTequila%';";
          break;
        case isset($_POST['mezcal']):
          $botonMezcal = $_POST['mezcal'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%levadura%' && categoria like '%$botonMezcal%';";
          break;
        case isset($_POST['vino']):
          $botonVino = $_POST['vino'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%levadura%' && categoria like '%$botonVino%';";
          break;
        case isset($_POST['cerveza']):
          $botonCerveza = $_POST['cerveza'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%levadura%' && categoria like '%$botonCerveza%';";
          break;
        default:
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%levadura%'";
      }
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <img class="levaduraCerveza" src="<?php echo $row[$i][4]; ?>" alt="" />
