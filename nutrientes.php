  ...
  <div class="page">
                ...
                <ul class="rd-navbar-nav menu-horizontal">
                  ...
                  <li class="rd-nav-item">
                    ...
                    <ul class="menu-vertical" id="menu-vertical" style="text-align: center;">
                      ...
                      <li class="rd-nav-item active" style="margin-left: 0px;"><a class="rd-nav-link" href="nutrientes.php" style="text-align: center;">Nutrientes</a></li>
    ...
    <section class="section novi-background section-xl">
      ...
      <div class="botonesProductos" class="section novi-background section-lg" style="text-align : center;">
        <h4>Seleccione la categoría de nutrientes que desee ver:</h4>
