    ...
    <section class="section novi-background section-xl" style="margin-top: 30px;">
      ...
      switch (isset($_POST)) {
        case isset($_POST['tequila']):
          ...
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonTequila%';";
          break;
        case isset($_POST['ron']):
          $botonRon = $_POST['ron'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonRon%';";
          break;
        case isset($_POST['mezcal']):
          $botonMezcal = $_POST['mezcal'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonMezcal%';";
          break;
        case isset($_POST['vino']):
          $botonVino = $_POST['vino'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonVino%';";
          break;
        case isset($_POST['charanda']):
          $botonCharanda = $_POST['charanda'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonCharanda%';";
          break;
        case isset($_POST['whisky']):
          $botonWhisky = $_POST['whisky'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonWhisky%';";
          break;
        case isset($_POST['cerveza']):
          $botonCerveza = $_POST['cerveza'];
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonCerveza%';";
          break;
        default:
          $consultaLogin = "SELECT * FROM ininbiowebapp.productos WHERE insumos LIKE '%nutriente%'";
      }
