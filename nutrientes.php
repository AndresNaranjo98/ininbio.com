...
<body>
  ...
  <div class="page">
                ...
                <ul class="rd-navbar-nav menu-horizontal">
                  ...
                  <li class="rd-nav-item">
                    ...
                    <li><a class="rd-nav-link" href="typography.php">Productos y servicios</a></li>
                      ...
                      <li class="rd-nav-item active"><a class="rd-nav-link" href="nutrientes.php">Nutrientes</a></li>
                  ...
                  <li id="productosInCart" class="rd-nav-item"><a class="rd-nav-link" href="carrito.php"><span class="icon novi-icon icon-sm mdi mdi-cart"></span></a>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="section novi-background section-xl" style="margin-top: 30px;">
      <h1 style="text-align: center;">Nutrientes</h1>
      <hr class="my-4" />
      <div class="botonesProductos" class="section novi-background section-lg" style="text-align : center;">
        ...
        <form action="" method="post">
          ...
          <button type="submit" id="vino" name="vino" value="vino" class="button button-md button-primary">Vino</button>
      ...
      switch (isset($_POST)) {
        case isset($_POST['tequila']):
          $botonTequila = $_POST['tequila'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonTequila%';";
          break;
        case isset($_POST['ron']):
          $botonRon = $_POST['ron'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonRon%';";
          break;
        case isset($_POST['mezcal']):
          $botonMezcal = $_POST['mezcal'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonMezcal%';";
          break;
        case isset($_POST['vino']):
          $botonVino = $_POST['vino'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonVino%';";
          break;
        case isset($_POST['charanda']):
          $botonCharanda = $_POST['charanda'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonCharanda%';";
          break;
        case isset($_POST['whisky']):
          $botonWhisky = $_POST['whisky'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonWhisky%';";
          break;
        case isset($_POST['cerveza']):
          $botonCerveza = $_POST['cerveza'];
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%' && categoria like '%$botonCerveza%';";
          break;
        default:
          $consultaLogin = "SELECT * FROM productos WHERE insumos LIKE '%nutriente%'";
      }
